...
print("Moteur en rotation...")

# Boucle jusqu'à atteindre la distance demandée
while True:
    ...
    # Conversion en tours
    total_tours = total_position_units / 4096.0

    print(f"Position cumulée: {total_tours:.3f} tours")

    # Test arrêt
    if abs(total_tours) >= distance_tours:
        print("Consigne atteinte, arrêt moteur.")
        break
