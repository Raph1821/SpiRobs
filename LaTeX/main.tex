...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Espacement}
            ...
            Enfin, il reste l'espacement $\Delta\theta$ à choisir entre les unités de la figure \ref{fig:spiral_logarithm} pour définir entièrement la forme et la taille du doigt. \cite{wang_spirobs_2025} Or, si $\theta$ va de $\pi$ à $3\pi$, le nombre de trapèzes N est :
        ...
        \subsubsection{Spirale déroulée}
            ...
            Pour construire le doigt, nous prenons exemple sur la figure \ref{fig:draw_solidworks}. Il est désormais question de traduire le formalisme mathématique de la spirale logarthmique en cote des différents trapèzes qui composent le doigt.
    ...
    \subsection{Cahier des charges} 
            ...
            \begin{itemize}
                ...
                \item Angle entre 2 trapèzes adjacents : $\Delta \theta \ = \ 30^o \ = \ \frac{\pi}{6} \ rad$
        ...
        \subsubsection{Application numérique}
            ...
            Comme montré dans l’équation (\ref{eq:nb_segment}), le nombre de trapèzes dépend de l’angle total $\theta_0$ et l'espacement $\Delta \theta$, on peut en déduire le nombre de trapèzes comme suit :

            \[
                N = \frac{2\pi}{\frac{\pi}{6}} = 12 
            \]
            
            Il y aura donc 12 trapèzes.
        ...
        \subsubsection{Dessin du doigt}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}[t]{0.5\textwidth}
                    ...
                    \caption{Extrusion du premier trapèze}
                \end{subfigure}
                \caption{Conception de la base}
