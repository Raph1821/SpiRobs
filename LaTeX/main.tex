...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Application numérique}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=0.7\textwidth]{Figures/resolu_b.png}
                \caption{Résolution numérique du paramètre $b$}
                \label{fig:resolu_b}
            \end{figure} 
            ...
            \textbf{Nous avons donc reçu la valeur de $b\ =\ 0.353403485288786$ et avons déduit $a$ de l'équation (\ref{eq:a}) pour $a\ =\ 0.07781868075936593$}
            ...
            \begin{table}[h!]
                ...
                \bottomrule
                \end{tabular}
                \caption{Valeur de $a$ calculées en fonction de $b$ avec $L=100$ mm.}
            \end{table}
