...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Choix et détermination des coefficients}
            ...
            \[
            L = \int_0^{\theta_0} \sqrt{r^2 + \left(\frac{dr}{d\theta}\right)^2} \, d\theta, \quad \text{pour} \ \theta_0 = \frac{11\pi}{6} \left( \frac{11}{12} \approx 1 \text{ tour complet} \right)^*
            \]
