...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Application numérique}
            ...
            Comme montré dans l’équation (\ref{eq:nb_segment}), le nombre de rainures dépend de l’angle total $\theta_0$ et l'espacement $\Delta \theta$, on peut en déduire $\theta_0$ comme suit :
    ...
    \subsection{Dessin sur SolidWorks}
        ...
        \subsubsection{Dessin du doigt}
            ...
            \subsubsection{3. Esquisse des rainures}
            Après avoir importé l’esquisse de la spirale aplatie, incluant différentes profondeurs de rainures trapézoïdales espacées selon les points définis, nous traçons les lignes de construction des trapèzes en fonction des largeurs calculées à l’aide de la formule suivante :
            \begin{equation}
...
\section{Résultats}
    ...
    \subsection{Simulation et étude de l'élasiticité via \textit{SolidWorks Simulation}}
        ...
        \subsubsection{Création d'un matériau TPU dans SolidWorks}
            ...
            Pour la simulation des contraintes et des déplacements via SolidWorks, nous devons implémenter dans le logiciel le TPU que nous utiliserons. Dans \cite{rodriguez-parada_influence_2021}, les auteurs utilisent un TPU de module d'Young de 26 MPa, mais les mesures expérimentales dans l’article montrent des valeurs beaucoup plus basses en pratique, selon la densité de remplissage lors de l'impression 3D. Comme notre but est d'éviter d'entrer dans le domaine plastique, nous chercherons à avoir un faible module d'Young. Nous décidons de prendre large avec un TPU de module d'Young 30 MPa pour la simulation afin d'avoir une première idée des forces maximales, et donc du couple moteur, à ne pas excéder.

        \subsubsection{Méthode}

            Nous restons dans l'hypothèse des petits déplacements pour des matériaux homogènes, isotropes et incompressibles (comme dans \cite{bhat_numerical_2025}).
