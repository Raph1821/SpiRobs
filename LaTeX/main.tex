...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Application numérique}
            ...
            \begin{lstlisting}[language=Python,caption={Résolution numérique du paramètre $b$},label={lst:resolu_b}]
    ...
    \subsection{Dessin sur SolidWorks}
        ...
        \subsubsection{Dessin du doigt}
            ...
            \begin{lstlisting}[language=Python,caption={Exportation d'une liste vers un fichier CSV avec \texttt{pandas}}, label={lst:export_csv}]
            import pandas as pd
