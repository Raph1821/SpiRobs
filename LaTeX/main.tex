...
\section{Conception de la pince}
    ...
    \subsection{Dessin sur SolidWorks}
        ...
        \subsubsection{Dessin de la transmission de couple}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}[t]{0.4\textwidth}
                    ...
                    \caption{Pièce attachée au moteur et vissée sur la vis mère}
            ...
            Comme illustré à la figure \ref{fig:piece_manquante}, nous concevons une pièce de fixation entre la vis et le moteur. Le servomoteur MX-106 de chez Dynamixel a été retenu pour ce montage, car il permet un contrôle précis en position et offre le couple le plus élevé parmi les moteurs que nous avion a disposition (10 Nm). Nous dessinons la pièce de transmission en nous inspirant de l’écrou déjà modélisé, en l’adaptant avec une plus grande hauteur accrue et en y ajoutant huit trous pour accueillir des vis de diamètre 2 mm (norme ISO M2), afin de pouvoir le fixer au moteur. Un filetage réaliste doit être dessiné pour pouvoir l'imprimer. Nous utilisons la fonctionnalité de SolidWorks permettant de fileter à l'aide de l'esquisse d'une hélice de pas 2,54 cm et d'une profondeur de 1 mm.
        ...
        \subsubsection{Dessin du support du moteur}
            ...
            Ensuite, le support du moteur est conçu à l’aide de la bibliothèque MAKERBEAM (voir figure \ref{fig:support}). Nous utilisons des barres de 40 mm, de 60 mm et de 200 mm (40x60x200), ainsi que des cubes de jonction pour les assembler. Pour fixer le support à la base, nous employons des vis et des boulons, ce qui nécessite l'ajout de trous dans la base, centrés sous chaque barre (voir figure \ref{fig:fixation_base_support}), afin de permettre le passage des vis.
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}[t]{0.6\textwidth}
                    ...
                    \caption{Support pour la vis et le moteur}
                ...
                \begin{subfigure}[t]{0.3\textwidth}
                    ...
                    \caption{Support monté}
                    \label{fig:support_acheve}
                \end{subfigure}
                \caption{Conception du support du moteur}
            \end{figure}

            Enfin, une nouvelle pièce est conçue pour assurer à la fois le maintien du moteur et le support de la vis mère. Elle sera imprimée en deux exemplaires. Comme illustré sur la figure \ref{fig:support_vis}, on distingue un orifice central destiné à recevoir la vis mère, avec un jeu de 0,3 mm pour faciliter le montage. Les perçages en bordure permettent la fixation du moteur à l’aide de vis, tandis que ceux situés sur les extensions latérales servent à fixer l’ensemble sur les barres MAKERBEAM (voir figure \ref{fig:support_acheve}).
        ...
        Nous allons utiliser une glissière de chez Igus, le modèle NK-01-27, et il s'agit désormais de la fixer au support MAKERBEAM, pour cela nous dessinons une nouvelle pièce.
...
\section{Résultats}
    ...
    \subsection{Simulation et étude de l'élasiticité via \textit{SolidWorks Simulation}}
        ...
        \subsubsection{Création d'un matériau TPU dans SolidWorks}
            ...
            Pour la simulation des contraintes et des déplacements via SolidWorks, nous devons implémenter dans le logiciel le TPU que nous utiliserons. Dans \cite{rodriguez-parada_influence_2021}, les auteurs utilisent un TPU de module d'Young de 26 MPa, mais les mesures expérimentales dans l’article montrent des valeurs beaucoup plus basses en pratique, selon la densité de remplissage lors de l'impression. Nous décidons de prendre un TPU de 30 MPa pour avoir une première idée des forces maximales, et donc du couple moteur, à ne pas excéder.
