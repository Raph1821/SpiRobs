...
\section{Conception de la pince}
    ...
    \subsection{Dessin sur SolidWorks}
        ...
        \subsubsection{Dessin du système vis-écrou}
            ...
            \begin{figure}
                ...
                \begin{subfigure}[t]{0.5\textwidth}
                    ...
                    \caption{Inspiration pour notre projet pour la conception du système vis-écrou \cite{w3d_tech_systeme_2023}}
                    \label{fig:vis_ecrou}
                \end{subfigure}
                \hfill
        ...
        Pour la conception du système vis-écrou, nous nous inspirons de la vidéo \cite{w3d_tech_systeme_2023} (voir figure \ref{fig:vis_ecrou}). Le rail supérieur (en vert) permet de garder fixe l'écrou, permettant sa translation lorsque la vis tourne. De surcroît, les câbles ne pourront s'emmêler grâce à ce système, puisque l'écrou ne tourne pas.
