...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Choix et détermination des coefficients}
            ...
            \textcolor{red}{$\theta_0 = \pi$ au lieu de $2\pi$ !!!}
    ...
    \subsection{Choix de l'actionneur}
        ...
        Dans le cadre de notre projet, nous allons utiliser un moteur et une vis sans fin, qui tirera des câbles de type UHMWPE, possédant un faible coefficient de frottement et une importante résistance à l'usure \cite{wang_spirobs_2025} \textit{détailler les propriétés de ces fils}.
