        ...
        \subsubsection{Dessin du support du moteur}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}[t]{0.3\textwidth}
                    ...
                    \caption{Pièces de fixation pour la vis et le moteur}
                ...
                \begin{subfigure}[t]{0.4\textwidth}
                    ...
                    \caption{Support assemblé avec les pièces de fixation (en rouge)}
                    \label{fig:support_acheve}
                \end{subfigure}
                \caption{Conception du support du moteur}
            \end{figure}

            Deux pièces supplémentaires sont conçues pour maintenir le moteur et fixer la vis mère. Comme illustré sur la figure \ref{fig:support_vis}, la première comporte un orifice central, prévu pour accueillir la vis mère avec un jeu de 0,3 mm facilitant le montage. La seconde présente des perçages en bordure permettant de fixer le moteur à l’aide de vis. Dans chacun des cas, les trous situés sur les extensions latérales servent à fixer la pièce sur les barres MAKERBEAM (voir figure \ref{fig:support_acheve}).
        ...
        \subsubsection{Dessin du système vis-écrou}
            ...
            \begin{figure}[H]
                ...
                \begin{subfigure}[t]{0.4\textwidth}
                    ...
                    \caption{Pièce pour fixer la glissière au support}
                \end{subfigure}
                \hfill
                \begin{subfigure}[t]{0.4\textwidth}
                    \centering
                    \includegraphics[width=\textwidth]{Figures/accroche_glissiere.png}
                    \caption{Glissière (en rouge) accrochée sur le support}
                \end{subfigure}
                \caption{Fixation de la glissière au support}
                \label{fig:attache_glissiere}
            \end{figure}

            Nous allons utiliser une glissière de chez Igus, le modèle NK-01-27, accompagnée d'un chariot de guidage, et il s'agit désormais de la fixer au support MAKERBEAM. Pour cela nous dessinons une nouvelle pièce permettant de monter la glissière sur le support (voir figure \ref{fig:attache_glissiere}).
