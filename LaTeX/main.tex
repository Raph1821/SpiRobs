...
\section{Conception de la pince}
    ...
    \subsection{Considérations mathématiques}
        ...
        \subsubsection{Choix et détermination des coefficients}
            ...
            \[
            L = \int_0^{\theta_0} \sqrt{r^2 + \left(\frac{dr}{d\theta}\right)^2} \, d\theta, \quad \text{pour} \ \theta_0 = \frac{11\pi}{6} \approx 2\pi \left( \approx 1 \text{ tour complet} \right)^*
            \]
        ...
        \subsubsection{Discussion sur le cahier des charges à respecter}
            ...
            \begin{itemize}
                \item Angle de conicité (ou \textit{taper\_angle}) : $\phi \ = \ 30^o \ = \ \frac{\pi}{6} \ rad$ 
                \item Angle entre 2 unicités adjacent : $\Delta \theta \ = \ 30^o \ = \ \frac{\pi}{6} \ rad$
                \item Longueur de la spirale centrale : $L \ = \ 10cm \ = \ 100mm$ 
                \item Nombre total de trapèzes : $N_u \ = \ 10$ et une base $N_b \ = \ 1$ donc $N \ = \ N_u \ + \ N_b \ = \ 11$
            \end{itemize}
            ...
            \[
            \theta_0 = N.\ \Delta \theta\ =\ 11\ .\ \frac{\pi}{6}\ =\ \frac{11\pi}{6} \approx 2\pi
            \]
