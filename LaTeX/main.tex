...
\section{Conception de la pince}
    ...
    \subsection{Dessin sur SolidWorks}
        ...
        \subsubsection{Dessin du support du moteur}
            ...
            En outre, le support du moteur est conçu à l’aide de la bibliothèque MAKERBEAM, disponible sur le site officiel. Nous utilisons des barres de 40 mm, de 60 mm et de 200 mm(40x60x200), ainsi que des cubes de jonction pour les assembler. Pour fixer le support à la base, nous employons des vis et des boulons, ce qui nécessite l'ajout de trous dans la base, centrés sous chaque barre (voir figure \ref{fig:support}), afin de permettre le passage des vis. Enfin, nous utiliserons le servomoteur MX-106, car il est contrôlé en position, et possède la plus grande puissance que l'on a à notre disposition (10 Nm).
        ...
        \subsubsection{Dessin de la transmission de couple}
            ...
            Comme illustré à la figure \ref{fig:piece_manquante}, une pièce est absente pour permettre la fixation de la vis au moteur. Nous concevons cette pièce en nous inspirant de l’écrou déjà modélisé, en l’adaptant avec une hauteur accrue et en y ajoutant huit trous destinés à accueillir des vis de diamètre 2 mm (norme ISO M2) pour la fixation au moteur. Un filetage réaliste, reprenant la forme arrondie de celui de l’écrou, est également modélisé avec un pas de 2,54 cm et une profondeur de 1 mm.
